...
states_dict = {}
states_dict[States.NAME_ROOM] = "It's time to create your own room! Lock the people up and watch them suffer but before that, how should we call your room?" 
...
states_dict[States.FILL_IN_PASSWORD] = "Great, password is the easy way, but sorry we just do numeric here. Just tell me the number."
